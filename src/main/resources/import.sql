...
-- =============================================
-- ⚠ IMPORTANTE: LOS PLANES ALIMENTICIOS SE GENERAN AUTOMÁTICAMENTE
-- No necesitas insertar en planalimenticio manualmente
-- El sistema los crea cuando un paciente se registra
-- =============================================
...
-- Pacientes 1-2: Plan Free (15 recetas máx)
-- Pacientes 3-4: Plan Premium (todas las recetas + citas)